        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <span className="section-tag" style={{ color: "oklch(0.72 0.14 85)" }}>
            ...
            <div
              ...
              onKeyDown={(e) => {
                if (e.key === "Enter" || e.key === " ") {
                  e.preventDefault();
                  handleCopy("ChengLin_2025", "wechat");
                }
              }}
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                >
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <title>微信图标</title>
                    <path
                      d="M7.5 3 C4.5 3 2 5.2 2 8 C2 9.5 2.7 10.8 3.8 11.7 L3.2 14 L5.8 12.7 C6.3 12.8 6.9 12.9 7.5 12.9 C7.6 12.9 7.7 12.9 7.8 12.9 C7.7 12.5 7.6 12.1 7.6 11.7 C7.6 9.1 10 7 13 7 C13.2 7 13.4 7 13.6 7 C13 4.7 10.5 3 7.5 3Z"
                      stroke="oklch(0.72 0.14 85)"
                      strokeWidth="1.2"
                      fill="none"
                    />
                    <path
                      d="M13 8.5 C10.5 8.5 8.5 10.1 8.5 12 C8.5 13.9 10.5 15.5 13 15.5 C13.6 15.5 14.2 15.4 14.7 15.2 L16.8 16.3 L16.3 14.4 C17.1 13.7 17.5 12.9 17.5 12 C17.5 10.1 15.5 8.5 13 8.5Z"
                      stroke="oklch(0.72 0.14 85)"
                      strokeWidth="1.2"
                      fill="none"
                    />
                ...
                <div>
                  <div className="section-tag" style={{ color: "oklch(0.60 0.10 85)" }}>
                    WeChat
                  </div>
                  <div
                    className="text-sm"
          ...
          >
            ...
            <p
              className="mt-5 text-xs font-mono-data"
          ...
          {/* 转化路径提示 */}
          <div
            className={`mt-12 pt-8 transition-all duration-700 ${
